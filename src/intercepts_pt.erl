...
%%
%% -------------------------------------------------------------------
-module(intercepts_pt).
-export([parse_transform/2]).

%% This parse transform looks for calls to intercepts:add/2, and if found
...
form({call,L,{remote,_,{atom,_,intercepts},{atom,_,AddFunction}}=Fun,Args})
